...
class WP_Test_MslsAdminIconTaxonomy extends Msls_UnitTestCase {
	...
	function test_constructor_method() {
		...
		$this->assertInstanceOf( 'AdminIconTaxonomy', $obj->set_href( $term_id ) );
		...
		$this->assertInstanceOf( 'AdminIconTaxonomy', $obj->set_href( 0 ) );
		...
		$obj = new AdminIconTaxonomy( 'test_tax_cat' );

		$this->assertInstanceOf( 'AdminIconTaxonomy', $obj->set_path() );
		$this->assertInstanceOf( 'AdminIconTaxonomy', $obj->set_language( 'it_IT' ) );
		$this->assertInstanceOf( 'AdminIconTaxonomy', $obj->set_src( '/dev/italian_flag.png' ) );
